...
typedef enum {
    ...
    ERROR_BASE_TIM_NODE_AUTO_BAUD_RATE_REQUEST = (ERROR_BASE_RTC + RTC_ERROR_BASE_LAST),
    ERROR_BASE_TIM_NODE_UNA_R4S8CR = (ERROR_BASE_TIM_NODE_AUTO_BAUD_RATE_REQUEST + TIM_ERROR_BASE_LAST),
    // MAC.
    ERROR_BASE_LMAC = (ERROR_BASE_TIM_NODE_UNA_R4S8CR + TIM_ERROR_BASE_LAST),
    // Utils.
